...
export default function ResultPage() {
  ...
  const { user, latestQuiz, failedQuestions, skippedQuestions } = results;
  const successRate = parseFloat(latestQuiz.successRate);
    ...
    <div className="space-y-6 py-10 px-4">
      ...
      <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-emerald-100">
        <div className="bg-gradient-to-r from-emerald-600 to-emerald-500 text-white text-center py-8">
          ...
          <p className="text-emerald-100 mt-2">Congratulations, {user.fullName}</p>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
              ...
              <div className="text-2xl font-bold text-red-700">{latestQuiz.incorrectAnswers}</div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
            ...
            <div className="text-3xl font-bold text-gray-900 mt-1">{user.totalScore}</div>
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              {showFailedQuestions && (
                <div className="mt-4 space-y-3">
                  {failedQuestions.map((question: Question, index: number) => (
            ...
            <div className="border-t border-gray-200 pt-4">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  {skippedQuestions.map((question: Question, index: number) => (
