...
import { useGetCBTUserHistoryQuery } from '../../Features/auth/authApi';
...
export default function QuizHistory() {
    ...
    const { data: historyData, isLoading: loading } = useGetCBTUserHistoryQuery(
        { userId: userId || "", subject: selectedSubject },
        { skip: !userId }
    );
    ...
    const { user: historyUser, overallStats, subjectPerformance, quizSessions } = history;
        ...
        <div className="space-y-6 py-6 px-4">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600">{historyUser.fullName}'s Performance Overview</p>
                    </div>
                </div>
                <button
            ...
            <div className="bg-gradient-to-r from-emerald-600 to-emerald-500 rounded-xl shadow-lg p-6 text-white">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    ...
                    <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                        <div className="text-2xl font-bold">{historyUser.totalScore}</div>
